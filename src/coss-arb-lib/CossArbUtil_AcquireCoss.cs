...
//    {
//        public void AcquireCossAgainstBinanceSymbolV5(string sym)
//        {
...
//                    {
//                        // throw new NotImplementedException($"Binance does not have order book {symbol}-ETH. The code for this scenario has not been tested.");
...
//            var shouldWeAvoidPurchasing = cossCommodity != null && (cossCommodity.CanWithdraw.HasValue && !cossCommodity.CanWithdraw.Value);
...
//                    if (string.Equals(baseSymbol, "ETH"))
//                    {
//                        // const decimal MinimumPermittedTradeEthValue = 0.00006m;
//                        if (quantity * price < MinimumTradeEth * 1.01m)
//                        {
//                            quantity = MathUtil.ConstrainToMultipleOf(MinimumTradeEth / price, getLotSize(symbol, baseSymbol));
...
//                var optimalCossSymbolBaseSymbolBidPrice = MathUtil.Truncate(binanceSymbolBaseSymbolBestBidPrice * (100.0m - OptimalPercentDiff) / 100.0m, MaxPriceDecimals);
...
//                if (bidPriceToPlace.HasValue && !baseSymbolsForKeptBids.Contains(baseSymbol))
//                {
//                    var price = bidPriceToPlace.Value;
//                    var availableBaseSymbol = balances.GetAvailableForSymbol(baseSymbol);

//                    var unconstrainedQuantity = baseSymbolToSpend.Value / price;
//                    if (unconstrainedQuantity >= availableBaseSymbol)
//                    {
//                        unconstrainedQuantity = 0.75m * availableBaseSymbol;
//                    }

//                    var quantity = MathUtil.ConstrainToMultipleOf(unconstrainedQuantity, getLotSize(symbol, baseSymbol));
//                    if (price * quantity < MinimumTradeBtc)
//                    {
//                        bidPriceToPlace = null;
//                        baseSymbolToSpend = null;
//                    }
//                }
...
//                var optimalSymbolCossBidPrice = MathUtil.Truncate(binanceSymbolBtcAveragePriceAsCoss * (100.0m - OptimalPercentDiff) / 100.0m, MaxPriceDecimals);
...
//                    var didWePlaceAnInstantBid = false;
...
//                        var quantity = MathUtil.ConstrainToMultipleOf(unconstrainedQuantity, getLotSize(symbol, baseSymbol));
//                        if (quantity * price >= MinimumTradeTusd)
//                        {
