...
namespace trade_strategy_lib_tests
{
    ...
    {
        private const decimal AutoBuyPercentThreshold = 7.5m;
        ...
        public void Setup()
        {
            _autoBuy = new AutoBuy(new Mock<ILogRepo>().Object);
        }
        ...
        public void Auto_buy__no_asks()
        {
            ...
            var results = _autoBuy.Execute(asks, BinanceBidPrice, MinimumTradeEth, AutoBuyPercentThreshold);
            results.Dump();
